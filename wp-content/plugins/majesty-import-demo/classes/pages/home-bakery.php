...
$image_1 = esc_url(wp_get_attachment_url($this->old_new_id['media'][14]));
$parallax_image = $this->old_new_id['media'][59];
$parallax_image_2 = $this->old_new_id['media'][47];
...
$content = '[vc_row box_padding="padding-100" extra_css="welcome-block"][vc_column offset="vc_col-md-7"][vc_column_text]<img class="img-responsive" src="'.$image_1.'" alt="intro" />[/vc_column_text][/vc_column][vc_column text_align="text-center" offset="vc_col-md-5"][vc_add_heading icon_type="iconmoon" icon="icon-intro" title="OUR HISTORY" subtitle="Welcome to Majesty"][vc_column_text]
