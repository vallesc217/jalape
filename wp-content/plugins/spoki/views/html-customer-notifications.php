                ...
                <tr>
                    <th>
                        <label for="leave_review" style="align-items: center;display: inline-flex;">
							...
							<?php if (!isset($this->options['woocommerce']['leave_review']) || $this->options['woocommerce']['leave_review'] != 1): ?>
                                <div class="spoki-badge"><?php _e('New', "spoki") ?></div>
							<?php endif ?>
                        </label>
                    </th>
                    <td>
                        ...
                        <p class="description">
							<?php _e("<b>After 5 days</b> from the completion of the order the customer will receive a notification to leave a <b>review on the website you prefer</b>.", "spoki") ?>
                        </p>
                        <br/>
