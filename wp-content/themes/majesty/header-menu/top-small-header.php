...
<div class="top-small-header">	
	<div class="container">
		<div class="row">
				...
				<ul>
					...
					<?php 
						if( ! empty( $majesty_options['booking_page'] ) ) {
							...
							if( $url ) {
								$page_id	= apply_filters( 'wpml_object_id', $majesty_options['booking_page'], 'page' );
					...
					<?php } } ?>
					<?php
						$more_links = $majesty_options['header_more_links'];
						if( ! empty( $more_links ) ) {
							foreach( $more_links as $htmltext ) {
						?>
			...
			<?php
				if( ! empty( $majesty_options['head_facebook'] ) || ! empty( $majesty_options['head_twitter'] ) || ! empty( $majesty_options['head_gplus'] ) || ! empty( $majesty_options['head_vimeo'] ) || ! empty( $majesty_options['head_youtube'] ) || ! empty( $majesty_options['head_instagram'] ) || ! empty( $majesty_options['head_pinterest'] ) || ! empty( $majesty_options['head_tripadvisor'] ) || ! empty( $majesty_options['head_foursquare'] ) ) {
			?>
