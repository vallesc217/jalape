	...
	<div class="container">
		<div class="row">           
			...
			<div class="wrap-menu-cart dark">
				...
				<?php if ( $majesty_options['display_top_cart'] || $majesty_options['display_search_icon'] ) { ?>
					<div class="wrap-cart-search-icon">	
						...
						?>
						<?php if( $majesty_options['display_search_icon'] ) { ?>
							<div class="search-icon-wrap">
								<a class="menu-search-icon" href="#" title="<?php esc_html_e('Search', 'theme-majesty'); ?>"><i class="fa fa-search"></i></a>
							</div>
						<?php } ?>
					</div>
				<?php } ?>
