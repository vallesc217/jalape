 ...
 */
if ( ! function_exists ( 'sama_woocommerce_post_class' ) ) {
 ...
 * @return  void
 */
if ( ! function_exists ( 'sama_add_css_class_to_li_products' ) ) {
 ...
 */
if ( ! function_exists ( 'sama_woocommerce_wrap_before_shop_loop' ) ) {
 ...
 * @hooked woocommerce_catalog_ordering - 30
 */
if ( ! function_exists ( 'sama_woocommerce_wrap_after_before_shop_loop' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists ( 'sama_remove_woocommerce_style' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists ( 'sama_dequeue_scripts_woo' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists ( 'sama_woocommerce_breadcrum_change' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_hidden_page_title' ) ) {
	function sama_woocommerce_hidden_page_title( $title ) {
		return false;
	}
}
if ( ! function_exists( 'sama_woocommerce_pagination_args' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_before_shop_loop_item' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_after_shop_loop_item' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_after_shop_loop_item_100' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_show_product_loop_featured' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_saleflash' ) ) {
 ...
 * @ since 1.7.1
 */
if ( ! function_exists( 'sama_woocommerce_shortcode_products_query' ) ) {
	//function sama_woocommerce_shortcode_products_query() {
	function sama_woocommerce_shortcode_products_query( $args ) {
		/*
		 * grid 			= 30
		 * list = list1 	= 31
		 * list2 			= 32
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_subcategory_thumbnail' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_short_description_wrap' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_custom_single_product_large_thumbnail_size' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_product_thumbnails_columns' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_review_gravatar_size' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_product_review_comment_form_args' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_related_products_args' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_woocommerce_before_main_content' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_woocommerce_after_main_content' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_before_single_product_summary_before_product_images' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_before_single_product_summary_after_product_images' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_template_single_priceafter' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_woocommerce_after_single_product_summary_before_tabs' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_before_upsell_display' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_after_upsell_display' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_output_before_related_products' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_output_after_related_products' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_custom_single_product_small_thumbnail_size' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_before_woo_sidebar' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_get_custom_excerpt_display_list' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_get_custom_excerpt' ) ) {
 ...
 * @ since 1.0
 */
if ( ! function_exists( 'sama_loop_shop_per_page' ) ) {
...
if ( ! function_exists( 'sama_woocommerce_template_loop_product_thumbnail' ) ) {
	function sama_woocommerce_template_loop_product_thumbnail() {
		echo woocommerce_get_product_thumbnail( 'majesty-shop-400' );
	}
}

if ( ! function_exists( 'sama_display_shop_categories' ) ) {
 ...
 * @ since 1.0
 */
	if ( ! function_exists( 'sama_woocommerce_image_dimensions' ) ) {
