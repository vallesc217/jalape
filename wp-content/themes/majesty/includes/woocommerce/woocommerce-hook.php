...
add_filter( 'woocommerce_post_class', 'sama_woocommerce_post_class', 10, 1 );
...
add_action('woocommerce_shortcode_before_product_category_loop', 'sama_woocommerce_shortcode_products_query', 10);
