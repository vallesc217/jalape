...
class Sama_Widget_Menu_Carousel extends WP_Widget {
	...
	function widget ($args, $instance) {
		...
		$items    				= isset( $instance['items'] ) ?  absint( $instance['items'] ) : 6;
		$itemsdesktop    		= isset( $instance['itemsdesktop'] ) ? absint( $instance['itemsdesktop'] ) : 3;
		$itemsdesktopsmall    	= isset( $instance['itemsdesktopsmall'] ) ? $instance['itemsdesktopsmall'] : 3;
		if ($navigation) {
