...
$output = '<span class="btns-group"><a href="'. esc_url($href) .'" title="'. esc_attr(strip_tags($title)) .'" '. implode( ' ', $wrapper_attributes ) .' target="'. esc_attr( $target ) .'">';
